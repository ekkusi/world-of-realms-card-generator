      ...
      {card.bgImgUrl ?
        <>
          ...
          <div className="absolute z-20 top-[4%] left-[6%] max-w-[20%] text-white">
            ...
            <span className="text-sm absolute bottom-[14%] w-full text-center text-white">DAMAGE</span>
          </div>
          <div className="absolute z-20 top-[4%] right-[6%] max-w-[20%] text-white">
            ...
            <span className="text-sm absolute bottom-[14%] w-full text-center">HEALTH</span>
          </div>
          <div className="absolute z-20 bottom-[30%] left-[6%] max-w-[20%] text-white">
            ...
            <span className="text-sm absolute bottom-[10%] w-full text-center">INFLUENCE</span>
          </div>
